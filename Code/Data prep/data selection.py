...
#%%
# Load data
data_path = '/Users/asmabaccouche/Heart disease project/Data/Preprocessed data/'
df = pd.read_csv(data_path+'data_clean1.csv')
# %%
...
data.to_csv('/Users/asmabaccouche/Heart disease project/Data/Preprocessed data/data_selected.csv', index=False)
